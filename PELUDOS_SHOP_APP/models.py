...
class ProductoProveedor(models.Model):
    CATEGORIAS = [
        ('comida_perros', 'Comida de perros'),
        ('comida_gatos', 'Comida de gatos'),
    ...
    categoria = models.CharField('Categoría', max_length=20, choices=CATEGORIAS, default='comida_perros')
    ...
    def __str__(self):
        return f"{self.id} | Nombre producto : {self.nombre_producto} | Nombre proveedor : {self.proveedor.nombre} | Categoria: {self.get_categoria_display()}"
